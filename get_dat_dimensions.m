function [rows,cols]=get_dat_dimensions(string)
    ...
    numstart_underscore=find(string=='_',1,'last');
    numstart_dash=find(string=='-',1,'last');
    numstart=max([numstart_underscore, numstart_dash]);
